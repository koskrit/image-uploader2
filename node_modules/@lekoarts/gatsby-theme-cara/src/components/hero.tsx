...
import FilePondInstance from "../elements/filepond";
  ...
  return (<div>
    ...
    <Divider speed={0.2} offset={offset} factor={factor}>
      <UpDown>
        ...
        <SVG icon="triangle" width={6} color="icon_darker" left="60%" top="15%" />
      </UpDown>
      <UpDownWide>
      ...
      <SVG icon="triangle" width={64} color="icon_green" left="95%" top="5%" />
      <SVG icon="triangle" hiddenMobile width={64} color="icon_purple" left="5%" top="90%" />
